...
<html lang="es">
    ...
    <body> 
        ...
        <div class="container">
        <img src="img/inicio.png" alt="inicio" class="center"/>
        ...
        <div class="container">
        <img src="img/alquiler.png" alt="alquiler" class="center"/>
        <img src="img/alquiler2.png" alt="alquiler" class="center"/>
        ...
        <div class="container">
        <img src="img/citas1.png" alt="citas general" class="center"/>
        <img src="img/citasmecanico.png" alt="citas mecanico" class="center"/>
        <img src="img/citasuser.png" alt="citas usuarios" class="center"/>
        ...
        <div class="container">
        <img src="img/tienda.png" alt="tienda" class="center"/>
        ...
        <div class="container">
        <img src="img/registro.png" alt="formulario registro" class="center"/>
        <img src="img/login.png" alt="formulario inicio de sesion" class="center"/>
        ...
        <div class="container">
        <img src="img/perfil.png" alt="perfil user" class="center"/>
        <img src="img/mecanico.png" alt="perfil mecanico" class="center"/>
        ...
        <div class="container">
            <img src="img/contacto.png" alt="contacto" class="center"/>
